...
class PublisherModel {
    ...
    static async addPublisher(publisherName, address, phone) {
        ...
        const result = await request
            .query('INSERT INTO Publisher (PublisherName, Address, Phone) OUTPUT INSERTED.PublisherID VALUES (@publisherName, @address, @phone)');
    ...
    static async updatePublisher(publisherId, publisherName, address, phone) {
        ...
        const result = await request
            .query('UPDATE Publisher SET PublisherName = @publisherName, Address = @address, Phone = @phone WHERE PublisherID = @publisherId');
        return result.recordset    
    }
